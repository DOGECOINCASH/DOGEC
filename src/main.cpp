...
#if defined(NDEBUG)
# error "DOGECOINCASH cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xaa521fcaa64514c5163a1abf4eb5b4930fe5f9a286b7e06a4c1e59a50da3fe93");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // DOGECOINCASH: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "DOGECOINCASH Signed Message:\n";
...
{
    // DOGECOINCASH: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 15000 blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // DOGECOINCASH: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // DOGECOINCASH: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaa521fcaa64514c5163a1abf4eb5b4930fe5f9a286b7e06a4c1e59a50da3fe93");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1436612408, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "11/Jul/2015 DOGECOIN 2015 Digital Cryptocurrency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xbbb22041a3c6c830f0651be25de6129ed8fbc937e73d5c39a44075d36993f660"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // DOGECOINCASH: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DOGECOINCASHMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DOGECOINCASHMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static DOGECOINCASHMiner(CWallet *pwallet)
{
    printf("DOGECOINCASHMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("dogecoincash-miner");
    ...
    try { loop {
        ...
        printf("Running DOGECOINCASHMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("DOGECOINCASHMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&DOGECOINCASHMiner, pwallet));
}
